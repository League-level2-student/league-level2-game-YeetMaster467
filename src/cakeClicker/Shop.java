...
public class Shop {
	...
	public static long money = 0; // MAKE SURE TO SET THIS BACK TO ZERO!!!
	int buttonWidth = 150;
	int buttonHeight = 50;
	...
	Button pie = new Button(330, 460, buttonWidth + 7, buttonHeight, "Pie Slice $5,700", new Color(204, 129, 129), 20, 0.6, 5_700);
